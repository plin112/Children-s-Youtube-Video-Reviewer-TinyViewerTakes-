...
router
    ...
    .post(async (req, res) => {
        ...
        try {
            ...
            const { title, reviewerName, review, rating ,comments} = req.body;
            //const userId = req.user.id;
            // just need to validate channelId, userId, reviewContent, and rating 
            // need to add userId to the createReview i think 

            const newReview = await reviewData.createReview(channelId, title, reviewerName, review, rating,comments);
